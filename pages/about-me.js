    ...
    return (
        <Layout>
            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap justify-center items-center">
                <div className="flex justify-center lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
                <img alt="feature" className="object-cover object-center h-500 w-500" src="/profile.jpg"/>
                </div>
                ...
                <div className="flex flex-col mb-10 lg:items-start items-center">
                    ...
                    저는 Node.js 기반의 백엔드 경험을 바탕으로,
                    React와 같은 최신 프론트엔드 프레임워크와 반응형 웹 디자인에 관심을 두고 UI/UX 중심의
                    프론트엔드 개발자로 성장하고자 합니다. <br/>
                    이전 직장에서 Playauto 2.0 솔루션 개발과 유지보수, 오픈API 설계 등 프로젝트를 담당하며 
                    사용자 관리와 보안 강화에 기여한 바 있습니다. <br/>
                    웹 퍼포먼스 최적화와 UX 개선에 열정을 가지고 있으며, 
                    협업과 소통을 중요하게 여깁니다. <br/>
                    작은 디테일까지 놓치지 않는 꼼꼼함과 책임감을 통해 프로젝트에 기여하는 개발자가
                    되겠습니다.
                    </p>
            ...
            <div className="flex flex-wrap -m-4">
                <div className="p-4 lg:w-auto md:w-full">
                    ...
                    <img alt="feature" className="object-cover object-center h-500 w-500 rounded-full" src="/github.png"/>
                    </div>
                    <div className="flex-grow">
                ...
                <div className="p-4 lg:w-auto md:w-full">
                    <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
                    <div className="w-16 h-16 sm:mr-8 sm:mb-0 mb-4 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
                    <img alt="feature" className="object-cover object-center h-500 w-500 rounded-full" src="/blog.png"/>
                    </div>
                    <div className="flex-grow">
